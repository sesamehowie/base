...
class DayOneNFT:
    ...
    def mint(self):
        ...
        value = int(Web3.to_wei(0.000111, "ether") * self.qty)

        tx_params = self.client.get_tx_params(
            to_address=self.minter_addr, value=value, data=data, default_gas=200000
        )
