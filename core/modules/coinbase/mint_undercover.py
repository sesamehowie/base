...
class NounsUnderCover:
    ...
    def mint(self):
        ...
        tx_params = self.client.get_tx_params(
            to_address=self.minter_addr, value=value, data=data, default_gas=190000
        )
